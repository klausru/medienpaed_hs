...
<div class="container page-search">
	<div class="page-header">
		<h1>
			{if $query}
				{translate key="plugins.themes.medienpaed_hs.search.resultsFor" query=$query|escape}
			{elseif $authors}
				{translate key="plugins.themes.medienpaed_hs.search.resultsFor" query=$authors|escape}
			{else}
	...
	<div class="row justify-content-lg-center">
		...
		<div class="col-lg-4 search-col-filters">
			<div class="search-filters">
				<h2>{translate key="plugins.themes.medienpaed_hs.search.params"}</h2>
				...
				<form class="form-search" method="get" action="{$smarty.capture.searchFormUrl|strtok:"?"|escape}">
					...
					<div class="form-group form-group-query">
						...
						<input type="search" class="form-control" id="query" name="query" value="{$query|escape}">
					</div>
